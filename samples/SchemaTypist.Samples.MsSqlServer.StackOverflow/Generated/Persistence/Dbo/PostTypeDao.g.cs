...
{
	public static partial class PostTypeDao
	{
		...
		public static partial class QueryResults
		{
			...
			{
				{Constants.Id, nameof(PostType.Id) },
				{Constants.Type, nameof(PostType.Type) },
			};
			...
			{
				var typeMap = new CustomPropertyTypeMap(typeof(PostType), GetMapperFunc());
