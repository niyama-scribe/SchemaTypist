...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class CollationMapper
		{
			static partial class Constants
			{
				...
				public const string PadAttribute = "pad_attribute";
			}
			...
			{
				public TableDefinition() : base("information_schema.collations")
				{
					...
					PadAttribute = new ColumnDefinition(Constants.PadAttribute, this);
				}
				...
				public ColumnDefinition PadAttribute { get; private set; }
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.CollationCatalog, nameof(Collation.CollationCatalog) },
					{Constants.CollationName, nameof(Collation.CollationName) },
					{Constants.CollationSchema, nameof(Collation.CollationSchema) },
					{Constants.PadAttribute, nameof(Collation.PadAttribute) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(Collation), GetMapperFunc());
