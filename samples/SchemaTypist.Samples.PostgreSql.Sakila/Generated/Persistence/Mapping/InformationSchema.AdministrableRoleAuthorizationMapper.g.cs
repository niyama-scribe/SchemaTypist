...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class AdministrableRoleAuthorizationMapper
		{
			...
			{
				public TableDefinition() : base("information_schema.administrable_role_authorizations")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.Grantee, nameof(AdministrableRoleAuthorization.Grantee) },
					{Constants.IsGrantable, nameof(AdministrableRoleAuthorization.IsGrantable) },
					{Constants.RoleName, nameof(AdministrableRoleAuthorization.RoleName) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(AdministrableRoleAuthorization), GetMapperFunc());
