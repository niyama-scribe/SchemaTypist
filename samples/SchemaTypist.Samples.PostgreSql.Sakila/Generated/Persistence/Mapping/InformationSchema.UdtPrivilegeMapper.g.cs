...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class UdtPrivilegeMapper
		{
			...
			{
				public TableDefinition() : base("information_schema.udt_privileges")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.Grantee, nameof(UdtPrivilege.Grantee) },
					{Constants.Grantor, nameof(UdtPrivilege.Grantor) },
					{Constants.IsGrantable, nameof(UdtPrivilege.IsGrantable) },
					{Constants.PrivilegeType, nameof(UdtPrivilege.PrivilegeType) },
					{Constants.UdtCatalog, nameof(UdtPrivilege.UdtCatalog) },
					{Constants.UdtName, nameof(UdtPrivilege.UdtName) },
					{Constants.UdtSchema, nameof(UdtPrivilege.UdtSchema) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(UdtPrivilege), GetMapperFunc());
