...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatioUserTableMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_statio_user_tables")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.HeapBlksHit, nameof(PgStatioUserTable.HeapBlksHit) },
					{Constants.HeapBlksRead, nameof(PgStatioUserTable.HeapBlksRead) },
					{Constants.IdxBlksHit, nameof(PgStatioUserTable.IdxBlksHit) },
					{Constants.IdxBlksRead, nameof(PgStatioUserTable.IdxBlksRead) },
					{Constants.Relid, nameof(PgStatioUserTable.Relid) },
					{Constants.Relname, nameof(PgStatioUserTable.Relname) },
					{Constants.Schemaname, nameof(PgStatioUserTable.Schemaname) },
					{Constants.TidxBlksHit, nameof(PgStatioUserTable.TidxBlksHit) },
					{Constants.TidxBlksRead, nameof(PgStatioUserTable.TidxBlksRead) },
					{Constants.ToastBlksHit, nameof(PgStatioUserTable.ToastBlksHit) },
					{Constants.ToastBlksRead, nameof(PgStatioUserTable.ToastBlksRead) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatioUserTable), GetMapperFunc());
