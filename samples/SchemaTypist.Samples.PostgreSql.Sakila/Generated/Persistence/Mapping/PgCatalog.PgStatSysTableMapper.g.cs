...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatSysTableMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_stat_sys_tables")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.AnalyzeCount, nameof(PgStatSysTable.AnalyzeCount) },
					{Constants.AutoanalyzeCount, nameof(PgStatSysTable.AutoanalyzeCount) },
					{Constants.AutovacuumCount, nameof(PgStatSysTable.AutovacuumCount) },
					{Constants.IdxScan, nameof(PgStatSysTable.IdxScan) },
					{Constants.IdxTupFetch, nameof(PgStatSysTable.IdxTupFetch) },
					{Constants.LastAnalyze, nameof(PgStatSysTable.LastAnalyze) },
					{Constants.LastAutoanalyze, nameof(PgStatSysTable.LastAutoanalyze) },
					{Constants.LastAutovacuum, nameof(PgStatSysTable.LastAutovacuum) },
					{Constants.LastVacuum, nameof(PgStatSysTable.LastVacuum) },
					{Constants.NDeadTup, nameof(PgStatSysTable.NDeadTup) },
					{Constants.NInsSinceVacuum, nameof(PgStatSysTable.NInsSinceVacuum) },
					{Constants.NLiveTup, nameof(PgStatSysTable.NLiveTup) },
					{Constants.NModSinceAnalyze, nameof(PgStatSysTable.NModSinceAnalyze) },
					{Constants.NTupDel, nameof(PgStatSysTable.NTupDel) },
					{Constants.NTupHotUpd, nameof(PgStatSysTable.NTupHotUpd) },
					{Constants.NTupIn, nameof(PgStatSysTable.NTupIn) },
					{Constants.NTupUpd, nameof(PgStatSysTable.NTupUpd) },
					{Constants.Relid, nameof(PgStatSysTable.Relid) },
					{Constants.Relname, nameof(PgStatSysTable.Relname) },
					{Constants.Schemaname, nameof(PgStatSysTable.Schemaname) },
					{Constants.SeqScan, nameof(PgStatSysTable.SeqScan) },
					{Constants.SeqTupRead, nameof(PgStatSysTable.SeqTupRead) },
					{Constants.VacuumCount, nameof(PgStatSysTable.VacuumCount) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatSysTable), GetMapperFunc());
