...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatioUserSequenceMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_statio_user_sequences")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.BlksHit, nameof(PgStatioUserSequence.BlksHit) },
					{Constants.BlksRead, nameof(PgStatioUserSequence.BlksRead) },
					{Constants.Relid, nameof(PgStatioUserSequence.Relid) },
					{Constants.Relname, nameof(PgStatioUserSequence.Relname) },
					{Constants.Schemaname, nameof(PgStatioUserSequence.Schemaname) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatioUserSequence), GetMapperFunc());
