...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatSysIndexMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_stat_sys_indexes")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.IdxScan, nameof(PgStatSysIndex.IdxScan) },
					{Constants.IdxTupFetch, nameof(PgStatSysIndex.IdxTupFetch) },
					{Constants.IdxTupRead, nameof(PgStatSysIndex.IdxTupRead) },
					{Constants.Indexrelid, nameof(PgStatSysIndex.Indexrelid) },
					{Constants.Indexrelname, nameof(PgStatSysIndex.Indexrelname) },
					{Constants.Relid, nameof(PgStatSysIndex.Relid) },
					{Constants.Relname, nameof(PgStatSysIndex.Relname) },
					{Constants.Schemaname, nameof(PgStatSysIndex.Schemaname) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatSysIndex), GetMapperFunc());
