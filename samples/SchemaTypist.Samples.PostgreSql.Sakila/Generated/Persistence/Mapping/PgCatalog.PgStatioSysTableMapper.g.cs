...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatioSysTableMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_statio_sys_tables")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.HeapBlksHit, nameof(PgStatioSysTable.HeapBlksHit) },
					{Constants.HeapBlksRead, nameof(PgStatioSysTable.HeapBlksRead) },
					{Constants.IdxBlksHit, nameof(PgStatioSysTable.IdxBlksHit) },
					{Constants.IdxBlksRead, nameof(PgStatioSysTable.IdxBlksRead) },
					{Constants.Relid, nameof(PgStatioSysTable.Relid) },
					{Constants.Relname, nameof(PgStatioSysTable.Relname) },
					{Constants.Schemaname, nameof(PgStatioSysTable.Schemaname) },
					{Constants.TidxBlksHit, nameof(PgStatioSysTable.TidxBlksHit) },
					{Constants.TidxBlksRead, nameof(PgStatioSysTable.TidxBlksRead) },
					{Constants.ToastBlksHit, nameof(PgStatioSysTable.ToastBlksHit) },
					{Constants.ToastBlksRead, nameof(PgStatioSysTable.ToastBlksRead) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatioSysTable), GetMapperFunc());
