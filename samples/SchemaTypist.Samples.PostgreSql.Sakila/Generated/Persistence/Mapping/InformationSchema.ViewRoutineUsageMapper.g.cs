...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class ViewRoutineUsageMapper
		{
			...
			{
				public TableDefinition() : base("information_schema.view_routine_usage")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.SpecificCatalog, nameof(ViewRoutineUsage.SpecificCatalog) },
					{Constants.SpecificName, nameof(ViewRoutineUsage.SpecificName) },
					{Constants.SpecificSchema, nameof(ViewRoutineUsage.SpecificSchema) },
					{Constants.TableCatalog, nameof(ViewRoutineUsage.TableCatalog) },
					{Constants.TableName, nameof(ViewRoutineUsage.TableName) },
					{Constants.TableSchema, nameof(ViewRoutineUsage.TableSchema) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(ViewRoutineUsage), GetMapperFunc());
