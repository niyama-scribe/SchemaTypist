...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class _pgForeignTableMapper
		{
			...
			{
				public TableDefinition() : base("information_schema._pg_foreign_tables")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.AuthorizationIdentifier, nameof(_pgForeignTable.AuthorizationIdentifier) },
					{Constants.ForeignServerCatalog, nameof(_pgForeignTable.ForeignServerCatalog) },
					{Constants.ForeignServerName, nameof(_pgForeignTable.ForeignServerName) },
					{Constants.ForeignTableCatalog, nameof(_pgForeignTable.ForeignTableCatalog) },
					{Constants.ForeignTableName, nameof(_pgForeignTable.ForeignTableName) },
					{Constants.ForeignTableSchema, nameof(_pgForeignTable.ForeignTableSchema) },
					{Constants.Ftoption, nameof(_pgForeignTable.Ftoption) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(_pgForeignTable), GetMapperFunc());
