...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatioUserIndexMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_statio_user_indexes")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.IdxBlksHit, nameof(PgStatioUserIndex.IdxBlksHit) },
					{Constants.IdxBlksRead, nameof(PgStatioUserIndex.IdxBlksRead) },
					{Constants.Indexrelid, nameof(PgStatioUserIndex.Indexrelid) },
					{Constants.Indexrelname, nameof(PgStatioUserIndex.Indexrelname) },
					{Constants.Relid, nameof(PgStatioUserIndex.Relid) },
					{Constants.Relname, nameof(PgStatioUserIndex.Relname) },
					{Constants.Schemaname, nameof(PgStatioUserIndex.Schemaname) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatioUserIndex), GetMapperFunc());
