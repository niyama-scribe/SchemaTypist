...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgAuthidMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_authid")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.Oid, nameof(PgAuthid.Oid) },
					{Constants.Rolbypassrl, nameof(PgAuthid.Rolbypassrl) },
					{Constants.Rolcanlogin, nameof(PgAuthid.Rolcanlogin) },
					{Constants.Rolconnlimit, nameof(PgAuthid.Rolconnlimit) },
					{Constants.Rolcreatedb, nameof(PgAuthid.Rolcreatedb) },
					{Constants.Rolcreaterole, nameof(PgAuthid.Rolcreaterole) },
					{Constants.Rolinherit, nameof(PgAuthid.Rolinherit) },
					{Constants.Rolname, nameof(PgAuthid.Rolname) },
					{Constants.Rolpassword, nameof(PgAuthid.Rolpassword) },
					{Constants.Rolreplication, nameof(PgAuthid.Rolreplication) },
					{Constants.Rolsuper, nameof(PgAuthid.Rolsuper) },
					{Constants.Rolvaliduntil, nameof(PgAuthid.Rolvaliduntil) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgAuthid), GetMapperFunc());
