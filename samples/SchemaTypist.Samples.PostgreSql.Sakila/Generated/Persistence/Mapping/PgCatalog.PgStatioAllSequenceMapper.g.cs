...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgStatioAllSequenceMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_statio_all_sequences")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.BlksHit, nameof(PgStatioAllSequence.BlksHit) },
					{Constants.BlksRead, nameof(PgStatioAllSequence.BlksRead) },
					{Constants.Relid, nameof(PgStatioAllSequence.Relid) },
					{Constants.Relname, nameof(PgStatioAllSequence.Relname) },
					{Constants.Schemaname, nameof(PgStatioAllSequence.Schemaname) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgStatioAllSequence), GetMapperFunc());
