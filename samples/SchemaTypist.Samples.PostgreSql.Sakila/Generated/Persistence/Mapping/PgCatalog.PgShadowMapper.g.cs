...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class PgShadowMapper
		{
			...
			{
				public TableDefinition() : base("pg_catalog.pg_shadow")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.Passwd, nameof(PgShadow.Passwd) },
					{Constants.Usebypassrl, nameof(PgShadow.Usebypassrl) },
					{Constants.Useconfig, nameof(PgShadow.Useconfig) },
					{Constants.Usecreatedb, nameof(PgShadow.Usecreatedb) },
					{Constants.Usename, nameof(PgShadow.Usename) },
					{Constants.Userepl, nameof(PgShadow.Userepl) },
					{Constants.Usesuper, nameof(PgShadow.Usesuper) },
					{Constants.Usesysid, nameof(PgShadow.Usesysid) },
					{Constants.Valuntil, nameof(PgShadow.Valuntil) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(PgShadow), GetMapperFunc());
