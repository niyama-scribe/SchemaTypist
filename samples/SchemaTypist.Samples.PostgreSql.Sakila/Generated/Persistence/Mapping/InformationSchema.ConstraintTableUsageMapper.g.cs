...
namespace SchemaTypist.Generated.Persistence.Mapping
{
	...
	{
		public static partial class ConstraintTableUsageMapper
		{
			...
			{
				public TableDefinition() : base("information_schema.constraint_table_usage")
				{
			...
			public static partial class QueryResults
			{
				...
				{
					{Constants.ConstraintCatalog, nameof(ConstraintTableUsage.ConstraintCatalog) },
					{Constants.ConstraintName, nameof(ConstraintTableUsage.ConstraintName) },
					{Constants.ConstraintSchema, nameof(ConstraintTableUsage.ConstraintSchema) },
					{Constants.TableCatalog, nameof(ConstraintTableUsage.TableCatalog) },
					{Constants.TableName, nameof(ConstraintTableUsage.TableName) },
					{Constants.TableSchema, nameof(ConstraintTableUsage.TableSchema) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(ConstraintTableUsage), GetMapperFunc());
