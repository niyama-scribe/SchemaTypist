...
namespace SchemaTypist.Samples.Postgres.NetCore.Sakila.Generated.Persistence.Public
{
	public static partial class PaymentP200701Dao
	{
		...
		public partial class TableDefinition : TabularDefinition
		{
			...
			public TableDefinition() : base("public.payment_p2007_01")
			{
		...
		public static partial class QueryResults
		{
			...
			{
				{Constants.Amount, nameof(PaymentP200701.Amount) },
				{Constants.CustomerId, nameof(PaymentP200701.CustomerId) },
				{Constants.PaymentDate, nameof(PaymentP200701.PaymentDate) },
				{Constants.PaymentId, nameof(PaymentP200701.PaymentId) },
				{Constants.RentalId, nameof(PaymentP200701.RentalId) },
				{Constants.StaffId, nameof(PaymentP200701.StaffId) },
			};
			...
			{
				var typeMap = new CustomPropertyTypeMap(typeof(PaymentP200701), GetMapperFunc());
