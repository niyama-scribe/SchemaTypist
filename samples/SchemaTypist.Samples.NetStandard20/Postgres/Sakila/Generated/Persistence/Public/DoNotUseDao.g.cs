...
{
	public static partial class DoNotUseDao
	{
		...
		public partial class TableDefinition : TabularDefinition
		{
			...
			public TableDefinition() : base("public.tbl_do_not_use")
			{
		...
		public static partial class QueryResults
		{
			...
			{
				{Constants.FirstColumn, nameof(DoNotUse.FirstColumn) },
				{Constants.SecondColumn, nameof(DoNotUse.SecondColumn) },
			};
			...
			{
				var typeMap = new CustomPropertyTypeMap(typeof(DoNotUse), GetMapperFunc());
