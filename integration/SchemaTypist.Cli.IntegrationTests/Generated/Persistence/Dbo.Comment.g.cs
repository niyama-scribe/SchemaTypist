	...
	static partial class Dbo
	{
		public static partial class Comment
		{
			...
			public static partial class QueryResultsMapper
			{
				...
				{
					{Constants.CreationDate, nameof(CommentEntity.CreationDate) },
					{Constants.Id, nameof(CommentEntity.Id) },
					{Constants.PostId, nameof(CommentEntity.PostId) },
					{Constants.Score, nameof(CommentEntity.Score) },
					{Constants.Text, nameof(CommentEntity.Text) },
					{Constants.UserId, nameof(CommentEntity.UserId) },
				};
				...
				{
					var typeMap = new CustomPropertyTypeMap(typeof(CommentEntity), GetMapperFunc());
