...
public class TemplateServiceTests
{
        ...
        TemplateService sut)
    {
        ...
        constructor!.Modifiers.Should().Contain(st => st.IsKind(SyntaxKind.PrivateKeyword), "Constructor should be private"); 
        ...
        innerClassConstructor?.Modifiers.Should().Contain(st => st.IsKind(SyntaxKind.PublicKeyword), "Inner class constructor should be public");
        buildMethod.Should().NotBeNull(); //Inner class must have a build method.
        buildMethod!.Modifiers.Should().Contain(mds => mds.IsKind(SyntaxKind.PublicKeyword), "Build method should be public.");
